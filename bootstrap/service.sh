...
set service dhcp-server shared-network-name MGMT subnet 172.16.10.0/24 static-mapping dev-k0 ip-address '172.16.11.16'
...
set service dhcp-server shared-network-name MGMT subnet 172.16.10.0/24 static-mapping dev-k1 ip-address '172.16.11.17'
...
set service dhcp-server shared-network-name MGMT subnet 172.16.10.0/24 static-mapping dev-k2 ip-address '172.16.11.18'
