...
set service dhcp-server shared-network-name MGMT subnet 172.16.11.0/24 static-mapping dev-k0 ip-address '172.16.11.16'
set service dhcp-server shared-network-name MGMT subnet 172.16.11.0/24 static-mapping dev-k0 mac-address '6c:4b:90:27:2d:5b'
set service dhcp-server shared-network-name MGMT subnet 172.16.11.0/24 static-mapping dev-k1 ip-address '172.16.11.17'
set service dhcp-server shared-network-name MGMT subnet 172.16.11.0/24 static-mapping dev-k1 mac-address '6c:4b:90:27:2e:a5'
set service dhcp-server shared-network-name MGMT subnet 172.16.11.0/24 static-mapping dev-k2 ip-address '172.16.11.18'
set service dhcp-server shared-network-name MGMT subnet 172.16.11.0/24 static-mapping dev-k2 mac-address '6c:4b:90:27:2e:11'
